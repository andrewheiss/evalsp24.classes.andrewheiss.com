...
3. Cite things in your document. [Check the documentation for full details of how to do this](https://quarto.org/docs/authoring/footnotes-and-citations.html). Essentially, you use `@citationkey` inside square brackets (`[]`):

...
**I've created a Quarto template you can use here:** [{{< fa file-archive >}} `measurement.zip`](/projects/measurement.zip). It's also [available on Posit.cloud](https://rstudio.cloud/spaces/269500/content/4357669).

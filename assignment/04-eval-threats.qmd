...
**I've created a Quarto template you can use here:** [{{< fa file-archive >}} `threats-validity.zip`](/projects/threats-validity.zip). It's also [available on Posit.cloud](https://rstudio.cloud/spaces/269500/content/4357671).
